...
handlers._checks.post = function (data,callback) {
    ...
    let successCodes = typeof (data.payload.successCodes) == 'object' && data.payload instanceof Array &&  data.payload.successCodes.length > 0 ? data.payload.successCodes : false;
